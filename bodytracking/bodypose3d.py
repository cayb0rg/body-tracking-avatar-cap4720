...
pose_keypoints = [
    ...
    # 9,  # Mouth Left
    # 10,  # Mouth Right
    11,  # Left Shoulder -> mixamorig_LeftArm
    12,  # Right Shoulder -> mixamorig_RightArm
    13,  # Left Elbow -> mixamorig_LeftForeArm
    14,  # Right Elbow -> mixamorig_RightForeArm
    15,  # Left Wrist -> mixamorig_LeftHand
    16,  # Right Wrist -> mixamorig_RightHand
    # 17,  # Left Pinky
    # 18,  # Right Pinky
    # 19,  # Left Pointer
    # 20,  # Right Pointer Finger
    # 21,  # Left Thumb
    # 22,  # Right THumb
    23,  # Left Hip -> mixamorig_LeftUpLeg
    24,  # Right Hip -> mixamorig_RightUpLeg
    25,  # Left Knee -> mixamorig_LeftLeg
    26,  # Right Knee -> mixamorig_RightLeg
    27,  # Left Ankle -> mixamorig_LeftFoot
    28,  # Right Ankle -> mixamorig_RightFoot
    # 29,  # Left Heel
    # 30,  # Right Heel
    # 31,  # Left Toe
    # 32   # Right Toe
